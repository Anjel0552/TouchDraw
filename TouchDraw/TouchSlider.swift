...
//  CustomSlider
//
//  Created by Anjel Villafranco on 10/2/15.
...
class TouchSlider: UIView {
    ...
    @IBInspectable var handleColor: UIColor = UIColor.redColor()
    ...
    override func drawRect(rect: CGRect) {
        ...
        CGContextFillEllipseInRect(context, CGRectInset(handleRect, 3, 3))
